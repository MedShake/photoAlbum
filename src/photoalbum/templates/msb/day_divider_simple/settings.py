...
from photoalbum.template_engine.api import A4, PageFormat, PageInstance, PlanItemKind
...
class DayDividerSimpleSettingsWidget(
    MsbTemplateSettingsWidget
):
    PREVIEW_WIDTH = 420
    def __init__(
    ...
    def _update_automatic_label(self) -> None:
        effective = automatic_format("day", self._temporal_context)
    ...
    def _load_state(self) -> None:
        selected = self._instance.settings.get("day_divider_simple", {}).get("title_format", "auto")
    ...
    def _changed(self, *args) -> None:
        ...
        settings["day_divider_simple"] = local
