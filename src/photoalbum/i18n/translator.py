...
CATALOGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "page_settings.scatter_proposal_group": "Photo scatter proposal",
        "page_settings.scatter_title_group": "Title",
        "page_settings.scatter_show_title": "Show title",
        "page_settings.scatter_title_mode": "Content",
        "page_settings.scatter_title_mode_automatic": "Automatic",
        "page_settings.scatter_title_mode_custom": "Custom",
        "page_settings.scatter_custom_title": "Custom title (Markdown)",
        "page_settings.scatter_custom_title_placeholder": "**My title**",
        "page_settings.scatter_title_position": "Position",
        "page_settings.scatter_title_position_very_high": "Very high",
        "page_settings.scatter_title_position_high": "High",
        "page_settings.scatter_title_position_upper_middle": "Upper-middle",
        "page_settings.scatter_title_position_center": "Centered",
        "page_settings.scatter_title_position_lower_middle": "Lower-middle",
        "page_settings.scatter_title_position_low": "Low",
        "page_settings.scatter_title_position_very_low": "Very low",
        "tab.photos": "Photos",
        ...
        "calendar_index.year_automatic": "Automatic",
        "calendar_index.show_title": "Show title",
        "month_divider.sample_cities_note": "Preview uses example city names.",
        ...
        "template.calendar-index": "Annual calendar",
        "template.year-divider-classic": "Simple year divider",
        "template.month-divider-classic": "Month divider with city list",
        "template.month-divider-simple": "Simple month divider",
        ...
        "template.simplex-full-photo-cover": "Full-page photo cover",
        "simplex.full-photo-cover.settings-title": "Settings — Full-page photo cover",
        "simplex.full-photo-cover.photo-group": "Photo",
        "simplex.full-photo-cover.photo": "Photo",
        "simplex.full-photo-cover.source": "Image source",
        "simplex.full-photo-cover.source-project": "Project photo",
        "simplex.full-photo-cover.source-external": "External file",
        "simplex.full-photo-cover.file": "File",
        "simplex.full-photo-cover.browse": "Browse…",
        "simplex.full-photo-cover.choose-file": "Choose a cover image",
        "simplex.full-photo-cover.image-filter": "Images (*.jpg *.jpeg *.png *.webp *.tif *.tiff);;All files (*)",
        "simplex.full-photo-cover.no-photo": "No project photo is available.",
        "simplex.full-photo-cover.title-group": "Title",
        "simplex.full-photo-cover.title-visible": "Show title",
        "simplex.full-photo-cover.title-mode": "Content",
        "simplex.full-photo-cover.title-mode-automatic": "Automatic",
        "simplex.full-photo-cover.title-mode-custom": "Custom",
        "simplex.full-photo-cover.custom-title": "Custom title (Markdown)",
        "simplex.full-photo-cover.custom-title-placeholder": "**My title**",
        "simplex.full-photo-cover.title-position": "Position",
        "simplex.full-photo-cover.title-position-very-high": "Very high",
        "simplex.full-photo-cover.title-position-high": "High",
        "simplex.full-photo-cover.title-position-upper-middle": "Upper-middle",
        "simplex.full-photo-cover.title-position-center": "Centered",
        "simplex.full-photo-cover.title-position-lower-middle": "Lower-middle",
        "simplex.full-photo-cover.title-position-low": "Low",
        "simplex.full-photo-cover.title-position-very-low": "Very low",
        "simplex.full-photo-cover.title-color": "Color",
        "simplex.full-photo-cover.title-font": "Font",
        "simplex.full-photo-cover.title-size": "Size",
        "simplex.full-photo-cover.choose-title-color": "Choose title color",
    ...
    "fr": {
        ...
        "page_settings.scatter_proposal_group": "Proposition de pêle-mêle",
        "page_settings.scatter_title_group": "Titre",
        "page_settings.scatter_show_title": "Afficher le titre",
        "page_settings.scatter_title_mode": "Contenu",
        "page_settings.scatter_title_mode_automatic": "Automatique",
        "page_settings.scatter_title_mode_custom": "Personnalisé",
        "page_settings.scatter_custom_title": "Titre personnalisé (Markdown)",
        "page_settings.scatter_custom_title_placeholder": "**Mon titre**",
        "page_settings.scatter_title_position": "Position",
        "page_settings.scatter_title_position_very_high": "Très haute",
        "page_settings.scatter_title_position_high": "Haute",
        "page_settings.scatter_title_position_upper_middle": "Mi-haute",
        "page_settings.scatter_title_position_center": "Centrée",
        "page_settings.scatter_title_position_lower_middle": "Mi-basse",
        "page_settings.scatter_title_position_low": "Basse",
        "page_settings.scatter_title_position_very_low": "Très basse",
        "tab.photos": "Photos",
        ...
        "calendar_index.year_automatic": "Automatique",
        "calendar_index.show_title": "Afficher le titre",
        "month_divider.sample_cities_note": "L’aperçu utilise des noms de villes d’exemple.",
        "calendar_index.page": "Page {page}",
        ...
        "template.calendar-index": "Calendrier annuel",
        "template.year-divider-classic": "Séparateur d’année simple",
        "template.month-divider-classic": "Séparateur de mois avec liste des villes",
        "template.month-divider-simple": "Séparateur de mois simple",
        ...
        "template.simplex-full-photo-cover": "Couverture pleine page",
        "simplex.full-photo-cover.settings-title": "Paramètres — Couverture pleine page",
        "simplex.full-photo-cover.photo-group": "Photo",
        "simplex.full-photo-cover.photo": "Photo",
        "simplex.full-photo-cover.source": "Source de l’image",
        "simplex.full-photo-cover.source-project": "Photo du projet",
        "simplex.full-photo-cover.source-external": "Fichier externe",
        "simplex.full-photo-cover.file": "Fichier",
        "simplex.full-photo-cover.browse": "Parcourir…",
        "simplex.full-photo-cover.choose-file": "Choisir une image de couverture",
        "simplex.full-photo-cover.image-filter": "Images (*.jpg *.jpeg *.png *.webp *.tif *.tiff);;Tous les fichiers (*)",
        "simplex.full-photo-cover.no-photo": "Aucune photo du projet n’est disponible.",
        "simplex.full-photo-cover.title-group": "Titre",
        "simplex.full-photo-cover.title-visible": "Afficher le titre",
        "simplex.full-photo-cover.title-mode": "Contenu",
        "simplex.full-photo-cover.title-mode-automatic": "Automatique",
        "simplex.full-photo-cover.title-mode-custom": "Personnalisé",
        "simplex.full-photo-cover.custom-title": "Titre personnalisé (Markdown)",
        "simplex.full-photo-cover.custom-title-placeholder": "**Mon titre**",
        "simplex.full-photo-cover.title-position": "Position",
        "simplex.full-photo-cover.title-position-very-high": "Très haute",
        "simplex.full-photo-cover.title-position-high": "Haute",
        "simplex.full-photo-cover.title-position-upper-middle": "Mi-haute",
        "simplex.full-photo-cover.title-position-center": "Centrée",
        "simplex.full-photo-cover.title-position-lower-middle": "Mi-basse",
        "simplex.full-photo-cover.title-position-low": "Basse",
        "simplex.full-photo-cover.title-position-very-low": "Très basse",
        "simplex.full-photo-cover.title-color": "Couleur",
        "simplex.full-photo-cover.title-font": "Police",
        "simplex.full-photo-cover.title-size": "Taille",
        "simplex.full-photo-cover.choose-title-color": "Choisir la couleur du titre",
